 ...
 * @author dinghao
 * @version 1.0.0
 * @ClassName ResponseParam.java
 * @Description TODO
 * @createTime 2020年04月22日 10:43:00
 */
public class ResponseParam extends HashMap<String, Object> {
    ...
    public ResponseParam pageParam(Page<?> page) {
        ...
        //设置分页参数信息
        this.put(appProperties.getPage().getPageNum(), page.getNumber() + appProperties.getPage().getPageNumStartIndex());
        ...
        this.put(appProperties.getPage().getTotalElements(), Ints.tryParse(page.getTotalElements() + ""));
